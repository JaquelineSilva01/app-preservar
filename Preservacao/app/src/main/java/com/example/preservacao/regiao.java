...
import com.example.preservacao.databinding.ActivityRegiaoBinding;

public class regiao extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void Localizacao() {
        ...
        LocationServices.getFusedLocationProviderClient(regiao.this)
                .requestLocationUpdates(locationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (locationResult != null && locationResult.getLocations().size() > 0) {
                            ...
                            Toast.makeText(regiao.this, "Região encontrada",
